...
the unique id and the second integer represents a value. Your task is to find an element from a and an element form b 
...
two sum can use hashtable(set), but this problem require less and equal and as close as possible.
So the first thought is sort and two pointers.
